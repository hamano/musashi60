...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT(
    ...
    KC_BSLS,KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   KC_INS, KC_HOME,KC_6,   KC_7,   KC_8,   KC_9,   KC_0,   KC_EQL, \
    _______,_______,_______,_______,_______,_______,KC_DEL, KC_END, CT_PGUP,KC_PGDN,KC_PGUP,CT_PGDN,KC_LCBR,KC_PIPE,\
