...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_RAISE] = LAYOUT(
    ...
    KC_PIPE,KC_EXLM,KC_AT,  KC_HASH,KC_DLR, KC_PERC,KC_DEL, KC_HOME,KC_CIRC,KC_AMPR,KC_ASTR,KC_LPRN,KC_RPRN,KC_PLUS,\
  ...
  [_LOWER] = LAYOUT(
    ...
    KC_BSLS,KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   KC_DEL, KC_HOME,KC_6,   KC_7,   KC_8,   KC_9,   KC_0,   KC_EQL, \
    _______,_______,_______,_______,_______,_______,KC_INS, KC_END, KC_LEFT,KC_DOWN,KC_UP,  KC_RGHT,KC_LCBR,KC_PIPE,\
