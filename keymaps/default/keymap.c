...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_EUCALYN] = LAYOUT(
    ...
    KC_GRV, KC_Q,   KC_W,   KC_F,   KC_R,   KC_J,   KC_DOT, KC_M,   KC_D,   KC_Y,   KC_P,   KC_MINS,\
    KC_GRV, KC_A,   KC_O,   KC_E,   KC_I,   KC_U,   KC_G,   KC_T,   KC_K,   KC_S,   KC_SCLN,KC_QUOT,\
    KC_LSFT,KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_H,   KC_COMM,KC_L,   KC_SLSH,KC_RSFT,\
    	    KC_LGUI,KC_LALT,KC_LCTL,KC_SPC, LOWER,  RAISE,  KC_ENT, KC_RCTL,KC_RALT,KC_RGUI         \
  ),
  [_QWERTY] = LAYOUT(
