...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    ...
    KC_BSLS,KC_MINS,KC_A,   KC_S,   KC_D,   KC_F,   KC_G,   KC_ESC,  KC_BSPC,KC_H,   KC_J,   KC_K,   KC_L,   KC_SCLN,KC_QUOT,KC_HOME,\
    KC_LGUI,MT_LALT,KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_TAB,  KC_ENT, KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,MT_RALT,KC_RGUI,\
            MT_LALT,                KC_LSFT,KC_LCTL,LOWER,  KC_SPC,  KC_SPC, RAISE,  KC_RCTL,KC_RSFT,                MT_RALT         \
  ),
  [_RAISE] = LAYOUT(
                    KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,                   KC_F6,  KC_F7,  KC_F8,  KC_F9,  KC_F10,                 \
    KC_HOME,KC_PGUP,KC_EXLM,KC_AT,  KC_HASH,KC_DLR, KC_PERC,                 KC_CIRC,KC_AMPR,KC_ASTR,KC_LPRN,KC_RPRN,_______,_______,\
    KC_END, KC_PGDN,KC_MS_L,KC_MS_D,KC_MS_R,KC_NO,  KC_NO,  KC_APP,  KC_NO,  KC_LEFT,KC_DOWN,KC_UP,  KC_RGHT,KC_NO,  KC_NO,  KC_END, \
    _______,_______,KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,   KC_NO,  KC_HOME,KC_END, KC_PGUP,KC_PGDN,KC_NO,  _______,_______,\
