...
#define RAISE LT(_RAISE, KC_SPC)      // Tap for Space, hold for Raise
#define LOWER LT(_LOWER, KC_SPC)      // Tap for Space, hold for Lower
...
#define MT_LSFT MT(MOD_LSFT, KC_DEL)  // Tap for Space, hold for LSFT
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT(
    ...
    _______,_______,_______,_______,_______,_______,CT_PGUP,KC_PGDN,KC_PGUP,CT_PGDN,KC_LBRC,KC_LCBR,\
