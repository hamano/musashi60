...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT(
    ...
    KC_BSLS,KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   CT_PGUP,KC_PGDN,KC_PGUP,CT_PGDN,KC_INS, KC_BSLS,\
    KC_LCBR,KC_6,   KC_7,   KC_8,   KC_9,   KC_0,   KC_BTN1,KC_BTN3,KC_BTN2,KC_BTN4,KC_DEL, KC_RCBR,\
                    _______,_______,_______,_______,_______,_______,_______,_______	                \
  )
};
