...
#define MT_CM MT(MOD_LCTL, KC_MHEN) // Tap for Ctrl, hold for Muhenkan
#define MT_CH MT(MOD_RCTL, KC_HENK) // Tap for Ctrl, hold for Henkan
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    ...
    KC_NO,  KC_LBRC,KC_Q,   KC_W,   KC_E,   KC_R,   KC_T,   KC_NO,    KC_NO,  KC_Y,   KC_U,   KC_I,   KC_O,   KC_P,   KC_RBRC,KC_PGUP,\
    ...
    KC_END, KC_EQL, KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_TAB,   KC_ENT, KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,KC_MINS,KC_PGDN,\
            KC_LGUI,                KC_LALT,MT_CM,  LOWER,  MT_LSS,   MT_RSS, RAISE,  MT_CH,  KC_RALT,                KC_RGUI         \
  ),
  [_RAISE] = LAYOUT(
